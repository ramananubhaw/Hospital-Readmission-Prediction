...
# %%
# y_test_proba = best_catboost_model.predict_proba(X_test)[:, 1] # Already done in evaluate_model, but kept for clarity
# y_test_pred_class = best_catboost_model.predict(X_test) # Already done in evaluate_model, but kept for clarity

# %%
print('\nBest CatBoost Model Evaluation on Test Set:')
evaluate_model(best_catboost_model)
